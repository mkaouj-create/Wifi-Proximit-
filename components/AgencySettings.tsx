      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Section title="Sécurité Administrateur" icon={<ShieldCheck size={20} />} fullWidth>
          <form onSubmit={handleChangePwd} className="flex flex-col md:flex-row gap-4 items-end">
            ...
            <button disabled={pwdLoading || !newPassword} className="w-full md:w-auto h-[62px] px-10 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-black text-[11px] uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-xl disabled:opacity-50">
